 function build_obslist()
    ...
    add_obs(IP_obs,"P_tts",string((@__DIR__),"/input/tts_P.dat"),false,false,false,0.125,"tt_P_dlnVp")
    return IP_obs
end
...
function build_fieldslist()
    ...
    add_field(IP_fields,"dlnVp","uniform",[-0.3,0.3],[-0.3,0.3],[-0.3,0.3],[-0.01,0.01],[0.0,0.0],0.0)    
    return IP_fields 
end
